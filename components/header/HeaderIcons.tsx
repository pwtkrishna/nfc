...
const HeaderIcons = ({ showOnlyCart = false }: Props) => {
  return (
    <div className="flex gap-2">
      {!showOnlyCart && (
        <>
          <div className="search-icon bg-[#35373E] rounded-[8px] h-[44px] w-[44px] flex justify-center items-center">
            <svg
          ...
          <div className="user-icon bg-[#35373E] rounded-[8px] h-[44px] w-[44px] flex justify-center items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="22"
              height="22"
