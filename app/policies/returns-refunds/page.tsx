        ...
        <div className="space-y-10">
          <section id="return-policy">
            ...
            <div className="prose prose-invert max-w-none">
              <p>
                ...
                you&apos;re not entirely happy with your order, we&apos;re here
                to help.
              </p>
              <p>
                You have 30 days from the date of delivery to return your items
                for a refund or exchange. After 30 days, we cannot offer you a
                refund or exchange.
              </p>
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <ol>
                <li>
                  ...
                  returns@yourcompany.com or call +1 (555) 123-4567 to request a
                  return. Please include your order number and the reason for
                  the return.
                </li>
                <li>
                ...
                <li>
                  ...
                  item(s) in the original packaging if possible. Include the RMA
                  number and your order information.
                </li>
                <li>
          ...
          <section id="exchanges">
            ...
            <div className="prose prose-invert max-w-none">
              <p>
                ...
                product, please follow the same process as for returns.
              </p>
          ...
          <section id="damaged-items">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <p>
                Please provide photos of the damaged or defective item when you
                contact us. This will help us process your claim more quickly.
              </p>
            </div>
          </section>
          ...
          <section id="cancellations">
            ...
            <div className="prose prose-invert max-w-none">
              <p>
                You can cancel an order within 24 hours of placing it, provided
                that the order has not yet been shipped. To cancel an order,
                please contact our customer service team as soon as possible
                with your order number.
              </p>
              <p>
                If your order has already been shipped, you will need to follow
                our return process once you receive the item.
              </p>
              <p>
                For custom or made-to-order items, cancellations may not be
                possible once production has begun. Please contact us as soon as
                possible if you need to cancel such an order.
              </p>
            </div>
          </section>
