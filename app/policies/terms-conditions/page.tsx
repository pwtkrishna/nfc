          ...
          <section id="introduction">
            ...
            <div className="prose prose-invert max-w-none">
              <p>
                ...
                use of our website and the products and services offered through
                it. By accessing or using our website, you agree to be bound by
          ...
          <section id="use-of-website">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <ul>
                ...
                <li>
                  Using the website in any way that causes, or may cause, damage
                  to the website
                </li>
                <li>
                ...
                <li>
                  Using the website for any purpose related to marketing without
          ...
          <section id="account-registration">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <p>
                ...
                your password. We encourage you to use a strong password (using
          ...
          <section id="products">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <p>
                ...
                colors and features of our products that appear on the website.
              ...
              <p>
                ...
                of our products to any person, geographic region, or
          ...
          <section id="limitation-of-liability">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <p>
                ...
                or any other legal theory, whether or not we have been informed
