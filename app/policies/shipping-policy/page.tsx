        ...
        <div className="space-y-10">
          ...
          <section id="shipping-methods">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <ul>
                <li>
                  <strong>Standard Shipping:</strong> Estimated delivery time of
                  5-7 business days.
                </li>
                <li>
                  <strong>Express Shipping:</strong> Estimated delivery time of
                  2-3 business days.
                </li>
                <li>
          ...
          <section id="shipping-rates">
            ...
            <div className="prose prose-invert max-w-none">
              <p>
                ...
                the distance to the destination, and the selected shipping
                method.
              </p>
              <p>
          ...
          <section id="international-shipping">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <p>
                ...
                These charges are not included in the shipping cost and will be
          ...
          <section id="tracking-information">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <p>
                ...
                after your order has been processed, please contact our customer
                service team.
              </p>
              <p>
          ...
          <section id="shipping-restrictions">
            ...
            <div className="prose prose-invert max-w-none">
              <p>
                We are unable to ship to P.O. boxes for certain products due to
                shipping carrier restrictions. If you provide a P.O. box address
                for these items, we will contact you to request an alternative
                shipping address.
              </p>
              <p>
                Some products may have shipping restrictions to certain
                countries due to local regulations or import restrictions. If
                you place an order for a product that cannot be shipped to your
                location, we will notify you and provide a refund.
              </p>
            </div>
          </section>
          ...
          <section id="delivery-issues">
            ...
            <div className="prose prose-invert max-w-none">
              <p>
                ...
                refused delivery, or failure to claim from the carrier, you will
                be responsible for the original shipping charges as well as any
                additional charges incurred for reshipping.
              </p>
              <p>
                In the event that your package is lost or damaged during
                transit, please contact our customer service team within 7 days
                of the expected delivery date. We will work with the shipping
                carrier to resolve the issue and may require you to file a claim
                with the carrier.
              </p>
            </div>
          </section>
