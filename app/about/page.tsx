        ...
        <div className="flex items-center justify-between gap-10 ">
          <div className="max-w-[540px] w-full flex-[1]">
            ...
            <p className="text-lg leading-6 pt-6 text-[#ffffffbf]">
              ...
              networking journey, and this has been our driving force in
              building TapOnn.
              <br />
              <br />
              ...
              opportunities for all. we&apos;ve ensured there&apos;s something
              for everyone seeking greater growth, networks, and opportunities.
              We believe in growing with you & hence continously thrive to
              upgrade our technology & tools to grow together. Download the
              TapOnn app and find all of us in your connections.
            </p>
          </div>
